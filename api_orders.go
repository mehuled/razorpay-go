...
/*
OrdersApiService Create a new Order
Create a new orders for a Payment
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Create a new order for a Payment
@return Order
*/
func (a *OrdersApiService) OrdersPost(ctx context.Context, body OrdersBody) (Order, *http.Response, error) {
	var (
